                            ...
                            <MDBCol>
                                <div class="card" id="borderNone">
                                    ...
                                    <div class="card-body text-center rounded-botton">
                                        <h4 class="card-title white-text">Evelin Fausto</h4>
                                        <hr class="white"></hr>
                        ...
                        <MDBRow className="my-5">
                            <MDBCol>
                                <div class="card" id="borderNone">
                                    ...
                                    <div class="card-body text-center rounded-botton">
                                        <h4 class="card-title white-text">Murilo Rodrigues</h4>
                                        <hr class="white"></hr>
                                        <p class="card-text white-text mb-4">Esse programa é incrivel, alunos increveis, tudo é incrivel.</p>
                                    </div>
                                </div>
                            </MDBCol>
                        </MDBRow>
                            ...
                            <MDBCol>
                                <MDBContainer className="w-100">
                                    <div class="card" id="borderNone">
                                        ...
                                        <div class="card-body text-center rounded-botton">
                                            <h4 class="card-title white-text">Gustavo Possebon</h4>
                                            <hr class="white"></hr>
                                            <p class="card-text white-text mb-4">Esse programa é incrivel, alunos increveis, tudo é incrivel.</p>
                                        </div>
                                    </div>
