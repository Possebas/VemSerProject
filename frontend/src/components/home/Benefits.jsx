        ...
        <React.Fragment>
            <MDBView className="photo">
                <MDBContainer className="textPhoto">
                    <h1 className="text-center mt-4 pt-5 white-text font-weight-bold">Benefícios</h1>
                    <MDBContainer className="w-100 h-100 pt-5 pb-5">
                        <MDBRow className="text-center mb-5">
                            <MDBCol>
                                <MDBIcon className="white-text pr-3 mb-3 mt-3" size="5x" icon="piggy-bank" />
                                <p>Bolsa auxílio mensal de R$800,00 durante a capacitação.</p>
                            </MDBCol>

                            <MDBCol>
                                <MDBIcon className="white-text pr-3 mb-3 mt-3" size="5x" icon="bus-alt" />
                            ...
                            <MDBCol >
                                <MDBIcon className="white-text pr-3 mb-3 mt-3" size="5x" icon="coffee" />
